...
[leopard](http://xinchanghao.github.io) 是一个简洁的博客模板，如果你也喜欢请 Star ，你的 Star 是我持续更新的动力, 谢谢 😄.
...
> $ git clone https://github.com/xinchanghao/xinchanghao.github.io.git

或者直接[下载博客](https://github.com/xinchanghao/xinchanghao.github.io/archive/master.zip)   

xinchanghao.github.io/ 目录下， 开启本地服务
...
如果你只想要我博客里的头像效果，你只需要拿 xinchanghao.github.io/_includes/side-panel.html 文件里面 `头像效果` 和 xinchanghao.github.io/css/main.css 里面最后面 `头像效果` 部分就行了。
